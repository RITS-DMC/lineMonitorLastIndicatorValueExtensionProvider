sap.ui.define([
    ...
    return PluginControllerExtension.extend("rits.custom.plugin.linemonitorpodplugins.lineMonitorLastIndicatorValueExtensionProvider.PluginEventExtension", {
        ...
        onIndicatorValueModification: function (oIndicatorData) {
            console.log("Modifying Indicator:", oIndicatorData);

            const oResponse = {
                value: oIndicatorData.value, 
                uom: oIndicatorData.uom,
                valueState: "Information" 
            };
            console.log("oResponse of Indicator values: ", oResponse);
            return oResponse;
        }
